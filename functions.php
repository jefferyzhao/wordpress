 ...
 * Globals
 */
define('THEMEDOC', 'http://docs.themeton.com/spare');
...
function themeton_enqueue_scripts() {
    ...
    wp_enqueue_script('theme-script', file_require(get_template_directory_uri().'/assets/js/scripts.js', true), false, false, true);
